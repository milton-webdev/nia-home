...
const accountItems = [
  {
    title: "Login",
    href: "http://coh.atwebpages.com/accounts/login.php"
  },
  {
    title: "Sign Up",
    href: "http://coh.atwebpages.com/accounts/register.php"
  }
];
...
const navListMenuItems = [
  {
    ...
    href: "https://dev.nia.co.zw"
  },
  {
    title: "Office Tools",
    href: "https://office.nia.co.zw"
  },
];
        ...
        <MenuHandler>
          <Typography as="a" href="#" variant="small" className="font-normal outline-none focus:outline-none">
            <MenuItem
              ...
              className="hidden items-center gap-2 text-blue-gray-900 lg:flex lg:rounded-full"
            >
              <Square3Stack3DIcon className="h-[18px] w-[18px]" /> Tools {" "}
              <ChevronDownIcon
                strokeWidth={2}
                className={`h-3 w-3 transition-transform ${
                  isMenuOpen ? "rotate-180" : ""
  ...
  return (
    ...
    >
      <div className="relative mx-auto flex items-center text-blue-gray-900">
        ...
        >
          <img className="w-32 mx-auto mb-4" src="Logo.png" />
        </Typography>
