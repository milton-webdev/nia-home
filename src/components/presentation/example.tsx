      ...
      <div className="h-full w-screen place-items-center bg-white px-8 py-20">
        <div className="container mx-auto relative">
          <div className="text-center mg:mx-64">
            ...
            >
              Nia Cloud is the starting point for your next project!
            </Typography>
            <Typography color="blue-gray" className="mb-8 lg:mx-80">
              Don’t spend hours reinventing the wheel! Our Cloud Platform comes packed with everything you need for you Online Store , Business and School.
            </Typography>
          </div>
