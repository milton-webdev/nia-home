      ...
      <div className="h-full w-screen place-items-center bg-white px-8 py-8">
        <div className="container mx-auto grid items-center relative lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            >
              Don't write from scratch. <br />
               Just ask Nia
            </Typography>
            <Typography color="blue-gray" className="lg:pr-20">
              Introducing the all new system that only uses drag-and-drop options to creative customized ai chatbots. Thanks to Nia you can now create your very own AI.
            </Typography>
            <a href="https://docs.nia.co.zw">
